...
(function () {
    ...
    const file$2 = "src/StickerPanel.svelte";
    ...
    function create_fragment$2(ctx) {
    	let div;
    	let ul;
    	let each_value = /*$rootStore*/ ctx[0].packs;
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$rootStore*/ 1) {
    				each_value = /*$rootStore*/ ctx[0].packs;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, rootStore, $$value => $$invalidate(0, $rootStore = $$value));
    	...
    	$$self.$capture_state = () => ({ panelStore, rootStore, $rootStore });
    	return [$rootStore];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 34, 2, 760);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
